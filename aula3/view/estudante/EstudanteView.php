...
<?php require_once $_SERVER['DOCUMENT_ROOT'] . '/' . FOLDER . '/view/navbar.php'; ?>
      ...
      <a href="/<?php echo FOLDER; ?>/?class=Estudante&acao=salvar" class="btn btn-primary">Cadastrar Estudante</a>
    </div>
  ...
  <tbody>
    ...
    <?php foreach ($listaEstudantes as $estudante) { ?>
           <tr>
                ...
                <td>
                    <a href="/<?php echo FOLDER; ?>?class=Estudante&acao=editar&id=<?php echo $estudante['id']; ?>" class="btn btn-primary">Editar</a>
                    <a href="/<?php echo FOLDER; ?>?class=Estudante&acao=excluir&id=<?php echo $estudante['id']; ?>" class="btn btn-primary">Excluir</a>
                </td>
           </tr>
