...
<br>
<br>
    <h2 class="text-primary text-center"> Cadastro de Professor</h2>
    <div class="container text-primary">
    <form method="POST" action="/<?php echo FOLDER; ?>/?class=Professor&acao=editar&id=<?php echo $professor["id"]; ?>">
